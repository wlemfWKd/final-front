...
const Board = () => {
    ...
    const initialData = [
        { id: 1, name: "게시글제목", instructor: "가격", totalLessons: "3000", category:"notice" },
        { id: 2, name: "freeboard", instructor: "가격", totalLessons: "5000", category:"freeboard" },
        { id: 3, name: "community-report", instructor: "가격", totalLessons: "15000", category:"community-report" },
        { id: 4, name: "copyright-report", instructor: "가격", totalLessons: "20000", category:"copyright-report" },
        { id: 5, name: "게시글제목3", instructor: "가격", totalLessons: "20000", category:"notice" },
        { id: 6, name: "게시글제목4", instructor: "가격", totalLessons: "20000", category:"notice" },
    ];
    ...
    return (
        <>
         ...
         <div className="mb-2">
                ...
                >
                    <FontAwesomeIcon icon={faPersonMilitaryPointing} className="icon_btn" />
                    커뮤니티 신고
                </Button>{' '}
                <Button
                    variant="secondary"
